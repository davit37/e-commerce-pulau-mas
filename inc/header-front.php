...
<html lang="en">
    ...
    <body>		
		<div id="top-bar" class="container">
			<div class="row">
				<div class="span4">
                <a href="index.php" class="logo pull-left"><img src="assets/themes-front/images/pmi2 (2).png" class="site_logo" alt=""></a>
					...
					<div class="account pull-right">
						...
						<ul class="user-menu">				
							...
							<?php }else{ ?>
                                ...
                                <li><a href="index.php?mod=chart&pg=retur">Retur</a></li>		
		...
		<section  class="homepage-slider" id="home-slider">
				<div class="flexslider">
					...
					<ul class="slides">
						...
						<li>
							<img src="upload/banner/header3.png" alt="" />
			...
			<section class="header_text">
				...
				if (!empty($_SESSION['nama'])){
					...
					?>
					</strong>Selamat Datang Di PMI GO E-Commerce</section>