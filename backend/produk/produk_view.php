...
<div>
	...
	<table  class="table table-striped table-condensed">
		<thead>
			<th><td><b>Nama Produk</b></td><td><b>Deskripsi</b></td><td><b>Kategori</b></td><td style='min-width: 100px'><b>Aksi</b></td></th>
		</thead>
		<tbody>
<?php
$batas='10';
...
while($rows=mysql_fetch_object($result)){
			...
			<td><?php echo $rows -> nama_kategori; ?></td>
				...
				<td>	
					...
					<a href="index.php?mod=produk&pg=produk_form&id=<?php echo $rows -> idproduk; ?>"

				class='btn btn-warning'> <i class="icon-pencil"></i></a><a href="index.php?mod=produk&pg=produk_view&act=del&id=<?php echo $rows -> idproduk; ?>"
